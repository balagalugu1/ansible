  ...
  content = templatefile("publicservers.tpl",
    {
      ...
      pvttestserver01 = aws_instance.docker-masters.0.private_ip
      pvttestserver02 = aws_instance.docker-masters.1.private_ip
      pvttestserver03 = aws_instance.docker-masters.2.private_ip
    }
  )
